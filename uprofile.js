...
const callCassandra = async () => {
    ...
    let client = new cassandra.Client({
        contactPoints: [`${config.contactPoint}:9042`],
    ...
    var query =
        `CREATE KEYSPACE IF NOT EXISTS ${config.keySpace} WITH replication = {'class': 'NetworkTopologyStrategy', '${config.localDataCenter}' : '3' }`;
